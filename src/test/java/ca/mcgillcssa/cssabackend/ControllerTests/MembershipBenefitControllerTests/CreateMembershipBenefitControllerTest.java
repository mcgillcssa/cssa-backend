package ca.mcgillcssa.cssabackend.ControllerTests.MembershipBenefitControllerTests;
...
import ca.mcgillcssa.cssabackend.controller.MembershipBenefitController.MembershipBenefitRequestBody;
...
public class CreateMembershipBenefitControllerTest {
  ...
  public void createMembershipBenefit_ReturnsOk() throws Exception {
    ...
    when(membershipBenefitService.createMembershipBenefit(anyString(), anyString(), anyString(), anyString(),
        anyString(), anyString(), anyString(), anyString(), anyList(), anyString()))
        .thenReturn(benefit);

    MembershipBenefitRequestBody requestBody = new MembershipBenefitRequestBody();
    ...
    requestBody.setMerchantImagesUrl(Arrays.asList("https://testimageurl1.com", "https://testimageurl2.com"));
    ...
    mockMvc.perform(post("/membershipBenefits/")
        ...
        .content(requestBodyJson)) // insert a JSON representation of MembershipBenefitRequestBody
  ...
  // ... other tests, e.g., for BAD_REQUEST and INTERNAL_SERVER_ERROR responses.
}
